...
@endif
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
            <form method="GET" action="{{ route('ongoing_ledger.index') }}" class="form-inline mb-3 d-flex justify-content-between">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('ongoing_ledger.update', $ledger->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
...
<div class="modal fade" id="deletemodal{{ $ledger->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-white" id="deleteModalLabel">Delete Loan Application</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('ongoing_ledger.destroy', $ledger->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('ongoing_ledger.store') }}" method="POST">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-xl-6 col-md-6">
