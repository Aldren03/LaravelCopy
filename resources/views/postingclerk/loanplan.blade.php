    ...
    <div class="container mt-3">
                        ...
                        <tbody>
                            @foreach($loanPlans as $loanPlan)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('loanplanedit', $loanPlan->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                        <form action="{{ route('loanplandestroy', $loanPlan->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('loanplanstore') }}" method="POST">
                    @csrf
