...
<div class="d-flex">
    ...
    <li class="mb-2">
    <a href="{{ route('credit_investigator.approved_requests') }}" class="block p-2 text-black hover:bg-green-200 rounded">Approved Applications</a>
</li>
<li class="mb-2">
    <a href="{{ route('credit_investigator.pending_requests') }}" class="block p-2 text-black hover:bg-green-200 rounded">Pending Requests</a>
</li>
    </ul>
</li>
        </ul>
