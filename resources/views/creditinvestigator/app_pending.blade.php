                        ...
                        <tbody>
                            @forelse($applications as $application)
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{ route('credit_investigator.application.show', ['id' => $application->id]) }}" class="btn btn-primary btn-sm">View</a>
<form action="{{ route('credit_investigator.application.approve', $application->id) }}" method="POST" style="display:inline;">
    @csrf
    @method('POST')
