...
@endif
    ...
    @if (session('success'))
        ...
        <form action="{{ route('manager.employee_view') }}" method="GET" class="mb-3 small-search-form">
            ...
            <table class="table table-striped table-bordered custom-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{ route('manager.employee_update', $employee->id) }}">Edit</a>
                            <a onclick="return confirm('Are you sure to delete this?');" class="btn btn-danger" href="{{ route('manager.employee_delete', $employee->id) }}">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="addEmployeeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered ">
            <form action="{{ route('manager.employee_add') }}" method="POST" enctype="multipart/form-data">
                @csrf
