    ...
    <div class="container mt-2">
        ...
        <form class="bg-white p-6 border border-gray-300 rounded-lg shadow-md">
            ...
            <div class="flex justify-between mt-4">
                <a href="{{ route('manager.approved_requests') }}" class="btn btn-secondary">Back to List</a>
                <button type="button" class="btn btn-primary" onclick="printForm()"><i class="lni lni-printer"></i></button>
            </div>
        </form>
    </div>
